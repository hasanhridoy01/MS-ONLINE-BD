...
export default function ServicesCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-[14px] leading-relaxed mb-4 text-justify min-h-[60px] text-gray-700">
      ...
      {link && link !== "#" ? (
        ...
        <p className="text-sm italic float-right cursor-not-allowed text-gray-700">No link here</p>
      )}
    </div>
  );
}
